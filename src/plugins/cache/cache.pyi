...
class Cache[KT, VT]:
    ...
    async def set(self, key: KT, value: VT, ttl: float | timedelta = ...) -> None: ...
    async def multi_set(
        self, pairs: Iterable[tuple[KT, VT]], ttl: float | timedelta = ...
    ) -> None: ...
    async def delete(self, key: KT) -> None: ...
    async def exists(self, key: KT) -> bool: ...
    async def increment(self, key: KT, delta: int = 1) -> int: ...
    async def expire(self, key: KT, ttl: float | timedelta) -> bool: ...
