...
from nonebot_plugin_alconna import Alconna, Match, Option, UniMessage, on_alconna
...
async def _(r18: Match) -> None:
    ...
    async with httpx.AsyncClient() as client:
        ...
        data = resp.json()
        if data["code"] != 0:
            await UniMessage.text(data["msg"]).finish(reply_to=True)
